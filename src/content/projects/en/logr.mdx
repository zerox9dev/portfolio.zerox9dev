...
<ProjectShot src="/projects/Logr/dashboard.png" caption="Dashboard: timer, timeline, projects, billable hours and a daily AI recap" />

<ProjectShot src="/projects/Logr/mobile.png" caption="Mobile layout — the same day, one column" />
